...
- **GPIO17**: PSTOP1 (通道1 的 SC8815 功率级启停控制，低电平启用)
- **GPIO18**: PSTOP2 (通道2 的 SC8815 功率级启停控制，低电平启用)
- **GPIO39**: PSTOP3 (通道3 的 SC8815 功率级启停控制，低电平启用，物理引脚44/MTCK)
- **GPIO40**: PSTOP4 (通道4 的 SC8815 功率级启停控制，低电平启用，物理引脚45/MTDO)
...
| **GPIO17** | 23 | PSTOP1 | SC8815 通道1 启停控制 | 低电平启用 |
| **GPIO18** | 24 | PSTOP2 | SC8815 通道2 启停控制 | 低电平启用 |
...
| **GPIO39** | 44 | PSTOP3 | SC8815 通道3 启停控制 | 低电平启用 (MTCK) |
| **GPIO40** | 45 | PSTOP4 | SC8815 通道4 启停控制 | 低电平启用 (MTDO) |
...
2. **端口管理**: PSTOP1-4 (GPIO17/18/39/40) 独立控制各路 SC8815 子板的启停
