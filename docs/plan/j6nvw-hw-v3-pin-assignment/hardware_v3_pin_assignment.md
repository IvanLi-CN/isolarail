...
| --- | --- | ---: | --- | --- | --- |
| I2C | I2C1_SDA | 8 | MCU →/← I2C | - | `SDA1`：输入 INA226、前面板、输出模块传感器 |
| I2C | I2C1_SCL | 9 | MCU →/← I2C | - | `SCL1`：输入 INA226、前面板、输出模块传感器 |
| I2C | I2C0_SDA | 14 | MCU →/← I2C | - | `SDA0`：主板 TCA6408A hub-sideband |
| I2C | I2C0_SCL | 13 | MCU →/← I2C | - | `SCL0`：主板 TCA6408A hub-sideband |
